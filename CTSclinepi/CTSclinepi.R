...
## ----trendplot, echo=c(2:3), out.width='100%', fig.dim=c(12,5)-------------------------------------------------
layout(t(1:2))
plot(1:365, frrseas(1:365), type="l", col=2, ylab="RR", xlab="Day of the year",
  main="Simulated seasonal effect")
plot(35:90, frrage(35:90), type="l", col=2, ylab="RR", xlab="Age",
...
plot(1:91, frrlag(1:91), type="l", col=2, ylab="RR", xlab="Lag",
  main="Simulated lag effect")


## ----lagexample, out.width='60%'-------------------------------------------------------------------------------
...
plot(seq(250), rrflu, type="l", col=2, ylab="Overall cumulative RR", xlab="Days",
  main="Example of cumulated effect")
points(c(15,100,110,160), rep(1,4), pch=19)
legend("topright", c("Flu episodes","Cumulated RR"), pch=c(19,NA), lty=c(NA,1),
  col=1:2, cex=0.8)


## ----origsim, message=FALSE------------------------------------------------------------------------------------
...
## ----followup, out.width='70%', fig.dim=c(7,4), echo=-c(1,5)---------------------------------------------------
par(mar=c(4,4,0.3,1))
...
## ----plotspl, echo=c(2:7), out.width='100%', fig.dim=c(8,6)----------------------------------------------------
...
colnames(resstr) <- c("RR","low95%CI","high95%CI")
